...
echo ""
echo "Logs:"
echo "  Backend (stdout):  ${LOG_DIR}/backend.log"
echo "  Backend (debug):   ${ROOT_DIR}/backend/debug.log"
...
echo ""
echo "To view logs:"
echo "  tail -f ${LOG_DIR}/backend.log       # uvicorn stdout"
echo "  tail -f ${ROOT_DIR}/backend/debug.log # app debug log"
